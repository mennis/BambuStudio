...
StringObjectException SLAPrint::validate(StringObjectException *exception, Polygons *_collision_polygons, std::vector<std::pair<Polygon, float>> *height_polygons) const
{
    for(SLAPrintObject * po : m_objects) {
